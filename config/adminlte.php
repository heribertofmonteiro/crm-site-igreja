    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'url' => 'pastoral/councils',
            'icon' => 'fas fa-users',
            'can' => 'governanca_pastoral.view',
        ],
        [
            'text' => 'Conselho Administrativo',
            'url' => 'pastoral/councils',
            'icon' => 'fas fa-cogs',
            'can' => 'governanca_pastoral.view',
        ],
        ...
        [
            'text' => 'Coordenação de Voluntariado',
            'url' => 'volunteer/roles',
        ...
        [
            'text' => 'Integração e Discipulado',
            'url' => 'admin/members',
            'icon' => 'fas fa-user-friends',
            'can' => 'gestao_membros_discipulado.view',
        ],
        ['header' => 'MINISTÉRIOS'],
        [
        ...
        [
            'text' => 'Infantil e Ensino',
            'url' => 'education/classes',
            'icon' => 'fas fa-child',
            'can' => 'ministerios_atividades.view',
        ],
        [
            'text' => 'Jovens e Adolescentes',
        ...
        [
            'text' => 'Missões',
            'url' => 'missions/missionaries',
            'icon' => 'fas fa-globe',
            'can' => 'ministerios_atividades.view',
        ],
        ['header' => 'COMUNICAÇÃO'],
        [
            'text' => 'Hub de Comunicação',
            'url' => 'communication/social_posts',
        ...
        [
            'text' => 'Tesouraria',
            'url' => 'finance/financial_accounts',
            'icon' => 'fas fa-dollar-sign',
            'can' => 'gestao_financeira.view',
        ],
        [
            'text' => 'Conselho Fiscal',
            'url' => 'finance/fiscal_council_meetings',
            'icon' => 'fas fa-balance-scale',
            'can' => 'gestao_financeira.view',
        ],
        ['header' => 'PATRIMÔNIO'],
        [
            'text' => 'Zeladoria e Manutenção',
            'url' => 'patrimony/assets',
            'icon' => 'fas fa-tools',
        ...
        [
            ...
            'url' => 'admin/church_events',
            'icon' => 'fas fa-calendar-alt',
            'can' => 'eventos_programacao.view',
        ],
        ['header' => 'CONTA'],
        [
            'text' => 'Conta',
