        ...
        <div class="relative z-10 w-full max-w-md">
            <div v-if="success" class="bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] rounded-3xl overflow-hidden p-8 sm:p-12">
                <div class="text-center">
                    ...
                    <p class="text-amber-200/70 mb-6">Seu cadastro foi realizado com sucesso. Aguarde aprovação do administrador para acessar o sistema.</p>
            ...
            <div v-else class="bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] rounded-3xl overflow-hidden p-8 sm:p-12 transition-all duration-500">
                ...
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center p-3 mb-4 rounded-2xl bg-gradient-to-br from-amber-500/30 to-purple-500/30 border border-amber-500/30">
                        <i class="fas fa-user-plus text-amber-400 text-2xl"></i>
                    </div>
                    <h1 class="text-2xl font-bold text-white tracking-tight mb-2 font-serif" 
                        style="background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
                        {{ systemName }}
                    </h1>
                    <p class="text-amber-200/70 text-sm font-medium tracking-wide uppercase">Novo Cadastro</p>
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        <label for="password_confirmation" class="block text-sm font-medium text-amber-100/80">Confirmar Senha</label>
                        <div class="relative">
                            <input 
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-white/40 italic">"Eleos好东西 são todos os que vem a mim..."</p>
                    <div class="mt-4 flex justify-center gap-4">
                        <a href="/login" class="text-amber-500 hover:text-amber-400 text-sm transition-colors">Já tenho conta</a>
